        ...
        <!-- Basic Forms -->
         <div class="box">
           ...
           <div class="box-body">
             <div class="row">
               <div class="col">
                   <form action="{{ route('teacher.profile.update', $editData->id) }}" method="POST" enctype="multipart/form-data">
                       @csrf
                     <div class="row">
                       <div class="col-12">	
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            <div id="img-preview">
                <div class="controls">
                    <img src="{{ (!empty($editData->image))? url('upload/employee_images/'.$editData->image) : 
