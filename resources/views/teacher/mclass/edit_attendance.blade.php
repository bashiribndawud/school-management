        ...
        <!-- Basic Forms -->
         <div class="box">
           <div class="box-header with-border">
             <h2 class="box-title">Edit Student Attandance for {{ $editData[0]->date }}</h2>
             <a href="{{ route('teacher.class.attendance.view') }}" style="float: right;" class="btn btn-rounded btn-success mb-5">back</a>
           ...
           <div class="box-body">
             <div class="row">
               <div class="col">
                   <form action="{{ route('update.student.attandance', $editData['0']['date']) }}" method="POST">
                       @csrf
                     <div class="row">
                       <div class="col-12">	
                ...
                <table class="table table-bordered table-striped" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center" id="{{ $data->id }}">
                            ...
                            <td colspan="3">
                                <div class="switch-toggle switch-3 switch-candy text-white">
