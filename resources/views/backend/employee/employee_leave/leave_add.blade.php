        ...
        <!-- Basic Forms -->
         <div class="box">
           ...
           <div class="box-body">
             <div class="row">
               <div class="col">
                   <form action="{{ route('store.employee.leave') }}" method="POST">
                       @csrf
                     <div class="row">
                       <div class="col-12">	
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            <input class="form-control" type="date" name="leave_start_date">
        </div>
    </div>
    {{-- End of col-6 --}}
    <div class="col-md-6">
        ...
        <div class="form-group">
            <input class="form-control" type="date" name="leave_end_date">
        </div>
    </div>
</div>
