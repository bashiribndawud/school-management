        ...
        <!-- Basic Forms -->
         <div class="box">
           <div class="box-header with-border">
             <h4 class="box-title">Employee Salary Increments</h4>
           ...
           <div class="box-body">
             <div class="row">
               <div class="col">
                   <form action="{{ route('update.salary.increment', $editData->id) }}" method="POST">
                       @csrf
                     <div class="row">
                       <div class="col-12">	
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            <input class="form-control" type="date" name="effected_salary">
        </div>
    </div>
</div>
