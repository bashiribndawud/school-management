        ...
        <!-- Basic Forms -->
         <div class="box">
           <div class="box-header with-border">
             <h4 class="box-title">Register Student</h4>
           ...
           <div class="box-body">
             <div class="row">
               <div class="col">
                   <form action="{{ route('store.student.reg') }}" method="POST" enctype="multipart/form-data">
                       @csrf
                     <div class="row">
                       <div class="col-12">	
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" class="form-control" name="special_ability" required >
                    </div>
                </div>
            </div>
