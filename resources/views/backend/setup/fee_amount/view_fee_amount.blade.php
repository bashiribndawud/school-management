                        ...
                        @foreach($allData as $key => $amount)
                          <tr>
                              ...
                              <td>
                                ...
                                <a href="{{ route('fee.amount.details', $amount->fee_category_id) }}" class="btn  btn-primary mb-5" >Details</a>
                                <a href="{{ route('fee.amount.details', $amount->fee_category_id) }}" class="btn  btn-danger mb-5" id="delete">Delete</a>
                              </td>
