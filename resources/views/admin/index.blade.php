...
<div class="content-wrapper">
    <div class="container-full">
        <?php 
            $student = DB::table('users')->where('usertype', 'student')->get();
            $teachers = DB::table('users')->where('usertype', 'employee')->get();
                  ...
                  <div class="box overflow-hidden pull-up">
                      <div class="box-body">							
                          ...
                          <div>
                              ...
                              <h3 class="text-white mb-0 font-weight-500"><strong>{{ $scount }}</strong> <small class="text-success"></small></h3>
                          </div>
                      </div>
                  </div>
              </div>
                  ...
                  <div class="box overflow-hidden pull-up">
                      <div class="box-body">							
                          ...
                          <div>
                              ...
                              <h3 class="text-white mb-0 font-weight-500"><strong>{{ $tcount }}</strong><small class="text-success"></small></h3>
                          </div>
                      </div>
                  </div>
              </div>
              <div class="col-xl-3 col-6">
                  <div class="box overflow-hidden pull-up">
                      <div class="box-body">							
                          ...
                          <div>
                              <p class="text-mute mt-20 mb-0 font-size-16">Administrator</p>
                              <h3 class="text-white mb-0 font-weight-500"><strong>{{ $acount }}</strong> <small class="text-danger"></small></h3>
                          </div>
                      </div>
                  </div>
              </div>
